...
<html lang="en">
	<head>
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="<?= base_url() ?>assets/assets/images/avatars/masjid2.jpg" type="image/x-icon">
					...
					<ul class="nav ace-nav">
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="<?= base_url() ?>assets/assets/images/avatars/masjid2.jpg" alt="Jason's Photo" />
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								<li>
									<a href="<?= base_url() ?>login/ganti_password/<?= $this->session->userdata('id_username') ?>">
								...
								<li>
									<a href="<?= base_url() ?>login/edit_profile/<?= $this->session->userdata('id_username') ?>">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="<?= base_url() ?>Kas_masjid_keluar">
									<i class="menu-icon fa fa-caret-right"></i>
							...
							<li class="">
								<a href="<?= base_url() ?>rekap_kas_masjid">
									<i class="menu-icon fa fa-caret-right"></i>
									Rekap Kas Masjid
								</a>
								<b class="arrow"></b>
					...
					<li class="">
						<a href="<?= base_url() ?>laporan">
							...
							<span class="menu-text"> Laporan Kas Masjid </span>
						</a>
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">Kelompok 1 - </span>
...
<![endif]-->
		...
		<script src="<?= base_url() ?>assets/assets/js/jquery.dataTables.bootstrap.min.js"></script>
		<script src="<?= base_url() ?>assets/assets/js/dataTables.buttons.min.js"></script>
		<script src="<?= base_url() ?>assets/assets/js/buttons.flash.min.js"></script>
		<script src="<?= base_url() ?>assets/assets/js/buttons.html5.min.js"></script>
		<script src="<?= base_url() ?>assets/assets/js/buttons.print.min.js"></script>
		<script src="<?= base_url() ?>assets/assets/js/buttons.colVis.min.js"></script>
		<script src="<?= base_url() ?>assets/assets/js/dataTables.select.min.js"></script>
