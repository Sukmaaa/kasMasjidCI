...
<form action="<?= base_url() ?>login/update_edit_profile/<?= $this->session->userdata('id_username') ?>" method="post" enctype="multipart/form-data" role="form">
  <div class="box-body">
    <div class="form-group">
      <input type="hidden" name="id_username" value="<?= $data_user['id_username'] ?>">

      <label for="exampleInputEmail1">Username</label>
      <input readonly="" type="text" class="form-control" id="exampleInputtext1" placeholder="" required="" value="<?= $data_user['username']?>" />

      <div class="warna"><?= form_error('username');?>
      </div>
    </div>
  </div>
  ...
  <div class="box-body">
    <div class="form-group">
      ...
      <div class="warna"><?= form_error('nama');?></div>
    </div>
  </div>
  ...
  <div class="box-body">
    <div class="form-group">
      ...
      <div class="warna"><?= form_error('email');?></div>
    </div>
  </div>
  ...
  <div class="box-body">
    <div class="form-group">
      ...
      <div class="warna"><?= form_error('alamat');?></div>
    </div>
  </div>
  ...
  <div class="box-body">
    <div class="form-group">
      ...
      <div class="warna"><?= form_error('kota');?></div>
    </div>
  </div>
  ...
  <div class="box-body">
    <div class="form-group">
      ...
      <div class="warna"><?= form_error('provinsi');?></div>
    </div>
  </div>
  ...
  <div class="box-body">
    <div class="form-group">
      ...
      <div class="warna"><?= form_error('telepon');?></div>
    </div>
  </div>
